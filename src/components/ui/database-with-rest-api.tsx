    ...
    >
      ...
      >
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          <g>
            <rect fill="#18181B" x="8" y="5" width="44" height="10" rx="5" />
            <IntakeIcon x="12" y="7" />
            <text
              x="20"
              y="12"
          ...
          <g>
            <rect fill="#18181B" x="54" y="5" width="44" height="10" rx="5" />
            <ResearchIcon x="58" y="7" />
            <text
              x="66"
              y="12"
              fill="white"
          ...
          <g>
            <rect fill="#18181B" x="100" y="5" width="44" height="10" rx="5" />
            <ValidateIcon x="104" y="7" />
            <text
              x="112"
              y="12"
              fill="white"
          ...
          <g>
            <rect fill="#18181B" x="146" y="5" width="44" height="10" rx="5" />
            <DeliverIcon x="150" y="7" />
            <text
              x="158"
              y="12"
              fill="white"
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-[#141516] font-semibold text-xs">
          {circleIcon ? circleIcon : circleText ? circleText : "SVG"}
        </div>
...
const IntakeIcon = ({ x = "0", y = "0" }: { x: string; y: string }) => {
  return (
    <g
    ...
    >
      <rect x="0" y="2" width="6" height="3" rx="0.6" />
      <path d="M3 0.6v2.2" />
      <path d="M2 1.6l1 1 1-1" />
    </g>
  );
};

const ResearchIcon = ({ x = "0", y = "0" }: { x: string; y: string }) => {
  return (
    <g
      transform={`translate(${x} ${y})`}
      stroke="white"
...
const ValidateIcon = ({ x = "0", y = "0" }: { x: string; y: string }) => {
  return (
    <g
      transform={`translate(${x} ${y})`}
      stroke="white"
      ...
      strokeLinejoin="round"
    >
      <path d="M3 0.6l2 0.9v2.1c0 1.4-0.9 2.4-2 2.8-1.1-0.4-2-1.4-2-2.8v-2.1z" />
      <path d="M2.1 3.3l0.7 0.7 1.3-1.3" />
    </g>
  );
};

const DeliverIcon = ({ x = "0", y = "0" }: { x: string; y: string }) => {
  return (
    <g
      transform={`translate(${x} ${y})`}
      stroke="white"
